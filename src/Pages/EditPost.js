...
function EditPost(props) {
    ...
    const [deneme, setDeneme] = useState("deneme yanılma")
                ...
                <div className='bg-sky-200  h-[500] w-[500px] rounded-xl '>
                    <form  className='p-5' >
                        <div className='flex items-center'>
                            <input value={deneme} onChange={(e)=>{setDeneme(e.target.value)}} placeholder="Post Tittle" className='bg-white w-2/3 h-10 focus:outline-none text-xs p-2 rounded placeholder:text-xs ' />
                            <div>
                        ...
                        <input placeholder="Post Description" className='bg-white w-full h-10 focus:outline-none text-xs mt-2 p-2 rounded placeholder:text-xs ' />
                        <div className='mt-2'>
                            <textarea                               
                        ...
                        <div className='flex items-center justify-between'>
                            ...
                            <button  className='font-semibold flex items-center gap-2 px-2 py-1 rounded-lg bg-sky-500 hover:opacity-70 text-white ml-5'>
                                <span>Edit Post</span>
                            </button>
                        </div>
                    </form>
