...
function UserPage() {
    ...
    const {
        ...
        jwt, setJwt, currentuser, setCurrentUser
    ...
    if (openEditPostModal) {
        return <EditPost setOpenEditPostModal={setOpenEditPostModal} />
    }
    ...
    return (
        <>
            {loading ? <Loading /> : <div className="grid grid-cols-12 max-w-4xl  mx-auto gap-3">
                <div className='col-span-11 grid grid-cols-12  border-l   '>
                    <div className='col-span-4 justify-center text-center bg-purple-50  '>
                                    ...
                                    <div key={i} className="flex border rounded-lg mt-5  justify-between p-2 bg-sky-100   ">
                                        <div className='p-2 w-3/5 flex flex-col justify-between '>
                                            ...
                                            <div className='flex items-center gap-8'>
                                                ...
                                                <div>
                                                    <FaRegEdit onClick={() => { console.log(id) }} size={20} className='cursor-pointer' />
                                                </div>
                                            </div>
                                        </div>
                                        <div >
